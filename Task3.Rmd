...
# (i) Overlay the theoretical N(1, 1/100) PDF curve
...
# (ii) Standardize the sample means
zn_n100 <- (sample_means_n100 - mu) / (sigma / sqrt(n2))

# (ii) Plot the empirical CDF (ECDF) of the standardized means
plot(ecdf(zn_n100),
...
# (ii) Overlay the standard normal CDF Φ(t)
curve(pnorm(x, 0, 1),
      add = TRUE,
      col = "red",
      lwd = 2)
...
# (ii) Compute d = max |F_n(t) - Φ(t)| (Kolmogorov-Smirnov statistic)
ks_test_n100 <- ks.test(zn_n100, "pnorm")
d_n100 <- ks_test_n100$statistic

# (ii) Compute the Berry-Esseen theoretical bound
